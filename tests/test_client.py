...
class TestExecuteQuery:
    ...
    def test_query_basic(self, owlbear_client):
    ...
    def test_query_no_wait(self, owlbear_client):
    ...
    def test_query_with_workgroup(self, owlbear_client):
    ...
    def test_query_failure(self, owlbear_client):
